...
Controller.prototype.store = function(){
    ...
    var response = function(e){if (e) {console.log(e)} else {console.log('saved',storage)}};
...
//    console.log('profile',this.profile)
    ...
    if (fs.existsSync('store.json')){
        fs.readFile('store.json',function(err,data){
            ...
            if (parsed.profile) self.ngcm.profile = parsed.profile;
            ...
            self.epoc.connect(self.ngcm.profile, function(e){
              //  console.log(e.time);
                if (e.blink) {
