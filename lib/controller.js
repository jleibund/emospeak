...
Controller.eventMap = {
    '/EXP/BLINK': 'blink',
    '/EXP/LOOK_LEFT': 'lookLeft',
    '/EXP/LOOK_RIGHT':'lookRight',
    '/EXP/WINK_LEFT': 'winkLeft',
    '/EXP/WINK_RIGHT':'winkRight',
    '/EXP/EYEBROW':'eyebrow',
    '/EXP/FURROW':'furrow',
    '/EXP/SMILE':'smile',
    '/EXP/CLENCH':'clench',
    '/EXP/SMIRK_LEFT':'smirkLeft',
    '/EXP/SMIRK_RIGHT':'smirkRight',
    '/EXP/LAUGH':'laugh'
};
...
//            }
    ...
    //                }
           ...
           if (action && e[Controller.eventMap[action]]) console.log(Controller.eventMap[action])
            if (e[Controller.eventMap[action]]) self.emit(action,e);
